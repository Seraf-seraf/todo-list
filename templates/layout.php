...
<head>
    ...
    <meta name="description" content="Веб приложение для составления списка дел">
    <meta name="keywords" content="todo, список дел, ежедневник, список задач, задачи">
    <title><?=$title?></title>
...
<body class="<?php isset($page_body_class) ? print($page_body_class) : ''?>">
<h1 class="visually-hidden"><?=$title?></h1>

<div class="page-wrapper">
    <div class="container <?=isset($user_id) ? 'container--with-sidebar' : ''?>">
        <header class="main-header">
            <a href="<?=isset($user_id) ? create_link(null, null, $show_completed ?? 0) : '/pages/guest-page.php'?>">
                <img src="../img/logo.png" width="153" height="42" alt="Логотип Дела в порядке">
            </a>

            <?php if (isset($user_id)): ?> 
                <div class="main-header__side">
                    <a class="main-header__side-item button button--plus" href="/pages/form-task.php">Добавить задачу</a>
        ...
        <div class="content">
            <?php if (isset($user_id)): ?>
                <section class="content__side">
                    <h2 class="content__side-heading">
                        <a href="<?=create_link(null, null, $show_completed ?? 0)?>">Проекты</a>
                    </h2>

                    <nav class="main-navigation">
                        <ul class="main-navigation__list">
                        <?php foreach($types_tasks as $type): ?>
                            <li class="main-navigation__list-item">
                                <a class="main-navigation__list-item-link 
                                    <?= $project_name == htmlspecialchars($type) ? 'main-navigation__list-item--active' : '' ?>" 
                                    href="<?=create_link($type, $search ?? '', $show_completed ?? 0)?>">
                                    <?=$type?>
                                </a>
                                <span class="main-navigation__list-item-count"><?=count_category($type)?></span>
                            </li>
                        <?php endforeach; ?>
                        </ul>
                    </nav>
            ...
            <?php else: ?>
                <section class="content__side">
                    ...
                    <a class="button button--transparent content__side-button" href="/pages/form-authorization.php">Войти</a>
                </section>
            <?php endif; ?>
